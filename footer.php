            ...
            <div class="row g-5">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-white mb-2" href="service.php"><i class="fa fa-angle-right me-2"></i>Our
                            Services</a>
...
<div class="container-fluid my-footer  text-white border-top border-primary px-0">
    <div class="d-flex flex-column flex-md-row justify-content-between">
        ...
        <div class="py-4 px-5 text-center text-md-start">
            <p class="mb-0">&copy; <a class="text-secondary" href="#">thinkpositiveestates.com</a>. All Rights Reserved.
            </p>
        </div>
